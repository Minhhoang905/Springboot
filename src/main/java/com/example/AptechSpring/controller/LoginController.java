...
public class LoginController {
    ...
    public String login(Authentication authentication) {
    	//Kiểm tra xem người dùng đã đăng nhập hay chưa thông qua đối tượng Athentication
...
//	public String doLogin(@ModelAttribute com.example.AptechSpring.form.LoginForm loginForm, ModelMap model) {
//
...
//	}
	...
	public String doRegister(@ModelAttribute LoginForm loginform, ModelMap model) {
		...
		//Tạo biến boolean và dùng method IsValid() ở UserService để check điều kiện đăng ký
	...
	public String doChangePass(@ModelAttribute LoginForm loginForm, ModelMap model) {
		...
		//Tạo 1 boolean và gọi method changePass từ UserService để kiểm tra và cập nhập mật khẩu
